      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl p-4 border border-slate-100">
          ...
          <div className="text-xs text-emerald-600 mt-1">
            {marketData?.initialPricesFetched ? 'Live Chainlink' : 'Loading...'}
          </div>
        </div>

        <div className="bg-white rounded-xl p-4 border border-slate-100">
          <div className="text-sm text-slate-600 mb-1">BTC Price</div>
          <div className="text-2xl font-bold text-slate-900">
        ...
        <div className="bg-white rounded-xl p-4 border border-slate-100">
          ...
          <div className="text-2xl font-bold text-slate-900">
            {marketData ? `${marketData.marketRisk} bps` : '25 bps'}
          </div>
          <div className="text-xs text-emerald-600 mt-1">
            {marketData?.initialPricesFetched ? 'Live Oracle' : 'Loading...'}
          </div>
        </div>
      </div>
