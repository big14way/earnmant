...
async function main() {
    console.log("🚀 Starting EarnX Protocol Deployment with NEW Verification Module...");
    ...
    console.log(`⚠️ Warning: Balance is very low (${hre.ethers.formatEther(balance)} ETH)`);
    console.log("   Consider getting more test ETH from a faucet before deployment");
    
    if (balance < hre.ethers.parseEther("0.0008")) {
        throw new Error("❌ Insufficient ETH balance for deployment. Need at least 0.0008 ETH");
    }
    ...
    try {
        ...
        console.log(`🎉 Using WORKING EarnXVerificationModule: ${verificationModuleAddress}`);
        ...
        try {
            ...
            console.log("✅ WORKING EarnXVerificationModule Status:");
        ...
        console.log("🔧 Setting Core Contract on NEW EarnXVerificationModule...");
        try {
            const currentCoreContract = await verificationModule.getCoreContract();
            console.log(`   Current core contract: ${currentCoreContract}`);
            ...
            if (currentCoreContract === "0x0000000000000000000000000000000000000000") {
                ...
                console.log("✅ NEW EarnXVerificationModule connected to Core successfully!");
                ...
                console.log(`⚠️ EarnXVerificationModule already connected to: ${currentCoreContract}`);
        ...
        try {
            ...
            console.log("✅ EarnXCore granted NFT minting permissions");
        } catch (error: any) {
        ...
        try {
            ...
            console.log("✅ EarnX Core Protocol Status:");
        ...
        console.log("\n🧪 Testing NEW EarnXVerificationModule...");
        try {
        ...
        console.log(`   ✅ WORKING EarnXVerificationModule: ${verificationModuleAddress}`);
        ...
        console.log("\n🏆 EARNX PROTOCOL WITH NEW VERIFICATION MODULE DEPLOYED!");
